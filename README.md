...
- [Notebooks Progression](#notebooks-progression)
...
The project is designed as a step-by-step learning progression:

| # | Notebook | What It Adds |
|---|---|---|
| 1 | `1_basic_rag.ipynb` | Basic retrieval + generation pipeline |
| 2 | `2_retrieval_refinement.ipynb` | Sentence-level knowledge refinement (decompose & filter) |
| 3 | `3_retrieval_evaluator.ipynb` | LLM-based document scoring (CORRECT / INCORRECT) |
| 4 | `4_web_search_refinement.ipynb` | Web search fallback for incorrect retrievals |
| 5 | `5_query_rewrite.ipynb` | Query rewriting for better web search results |
| 6 | `6_ambiguous.ipynb` | **Full CRAG** — adds AMBIGUOUS handling with dual-source merging ⭐ |
